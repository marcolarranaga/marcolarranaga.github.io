<!-- Navigation Bar -->
<nav style="display: flex; justify-content: center; background-color: #333; padding: 10px 0; position: fixed; width: 100%; top: 0; left: 0; z-index: 1000;">
    <a href="#About-me" style="color: #FFF; text-decoration: none; margin: 0 15px; font-size: 18px;">About Me</a>
    <a href="#Research-interest" style="color: #FFF; text-decoration: none; margin: 0 15px; font-size: 18px;">Research Interest</a>
    <a href="#Publications" style="color: #FFF; text-decoration: none; margin: 0 15px; font-size: 18px;">Publications</a>
    <a href="#Contact" style="color: #FFF; text-decoration: none; margin: 0 15px; font-size: 18px;">Contact</a>
</nav>
